...
```
  <connectionStrings>
    <add name="RoleClaimContext" connectionString="Data Source=(LocalDb)\v11.0;Initial Catalog=GCCSI_CO2RE;Integrated Security=SSPI;AttachDBFilename=|DataDirectory|\GCCSI_CO2RE.mdf;" providerName="System.Data.SqlClient" />
  </connectionStrings>
  ```
